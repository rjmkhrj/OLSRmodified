...
RoutingProtocol::SetIpv4 (Ptr<Ipv4> ipv4)
{
 ...
 //uint16_t will = rand() % 8;                             //Changed here
 ...
 // singhop n;  //Changed here
  ...
  {  
     if (x->will > 2)
     {
       ...
       //m_state.RemovesingleTuple(x->mainAddr);
      ...
      if (nb_tuple.status == NeighborTuple::STATUS_SYM)
        {
          ...
          for (LinkSet::const_iterator it2 = linkSet.begin ();
               it2 != linkSet.end (); it2++)
            {
              ...
              if ((GetMainAddress (link_tuple.neighborIfaceAddr) == nb_tuple.neighborMainAddr) // && (nb_tuple.willingness < 2) && (nb_tuple.N_symmetric == true))   //Changed here
                               ...
                               const Ipv4Address &senderIface)
{
  ...
  {
    const NeighborSet &neigh = m_state.GetNeighbors();
    for (NeighborSet::const_iterator it = neigh.begin (); it != neigh.end (); it++)   //Changed here
    {
       if(it->neighborMainAddr == senderIface)
       {
           NeighborTuple tuple;
           tuple.neighborMainAddr = senderIface;
           tuple.willingness = it->willingness;
           tuple.status = it->status;
           tuple.degree = it->degree;
